...
const useChangeFormStep = (): UseChangeFormStepReturn => {
    ...
    const changeStep = (formDirection: FormDirection) => {        
        if (formDirection !== 'prev' && formDirection !== 'next') return    
        
        const nextStep = formDirection == 'next' ? currentStep + 1 : currentStep - 1
